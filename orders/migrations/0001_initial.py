    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.IntegerField(choices=[(0, 'CART_STAGE'), (2, 'ORDER_PROCESSED'), (3, 'ORDER_DELIVERD'), (4, 'ORDER_REJECTED')], default=0)),
                ('delete_status', models.IntegerField(choices=[(1, 'Live'), (0, 'Delete')], default=1)),
                ('created_at', models.DateTimeField(auto_now=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cart_owner', to='customer.customer')),
            ],
        ),
        migrations.CreateModel(
            name='orderedItem',
